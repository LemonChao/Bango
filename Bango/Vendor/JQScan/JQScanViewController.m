...
- (void)viewDidLoad {
    ...
    [self axcBaseAddLeftBtnWithImage];
}
...
//    [self.navigationController pushViewController:vc animated:YES];
    if (self.resultsCallback) {
        ...
        self.resultsCallback(strResult);
...
- (void)axcBaseAddLeftBtnWithImage{
    UIButton *baseRightImageButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 30, 40)];
    [baseRightImageButton setImage:[UIImage imageNamed:@"back"] forState:UIControlStateNormal];
    baseRightImageButton.imageView.contentMode = UIViewContentModeScaleAspectFit;
    [baseRightImageButton addTarget:self action:@selector(axcBaseClickBaseLeftImageBtn:) forControlEvents:UIControlEventTouchUpInside];
