...
typedef NS_ENUM(NSInteger,ListRequestDataType)
{
    /** 下拉刷新*/
    ListDropdownRefreshType,
     /** 上拉加载*/
    ListPullOnLoadingType
};
typedef NS_ENUM(NSInteger,DataStyleType)
{   //继续加载数据
    DataContinueToLoadType,
    //暂无数据
    DataNoNewType
};
...
/**
 请求类型
 */
@property (nonatomic,assign)ListRequestDataType requestDataType;

/**
 数据请求结果
 */
@property (nonatomic,assign)DataStyleType dataStyleType;
/**
 *  是否隐藏提示框
 */
