//
//  UIViewController+LKBubbleView.m
//  TFC
//
//  Created by 张海彬 on 2018/6/21.
//  Copyright © 2018年 张海彬. All rights reserved.
//

#import "UIViewController+LKBubbleView.h"

@implementation UIViewController (LKBubbleView)
...
- (void)showRightWithTitle: (NSString *)title autoCloseTime: (CGFloat)autoCloseTime{
    LKBubbleInfo *info = [self getDefaultRightBubbleInfo];
    info.title = title;
    [[LKBubbleView defaultBubbleView] showWithInfo: info autoCloseTime: 3];
}
...
- (void)showRoundProgressWithTitle: (NSString *)title{
    LKBubbleInfo *info = [self getDefaultRoundProgressBubbleInfo];
    info.title = title;
